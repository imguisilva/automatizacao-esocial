...
__all__ = [
    ...
    'SynchronizedInputType_LeftMouseUp', 'UIA_Drag_DragCancelEventId',
    'TreeScope_Parent', 'IUIAutomationProxyFactoryMapping',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_TransformCanMovePropertyId', 'IUIAutomationValuePattern',
    'IUIAutomationTextPattern', 'TreeScope_Descendants',
    'UIA_ComboBoxControlTypeId',
    'SynchronizedInputType_RightMouseDown', 'IUIAutomationElement5',
    'IUIAutomationTablePattern',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'ExpandCollapseState', 'UIA_DropTargetDropTargetEffectPropertyId',
    'ScrollAmount_NoAmount', 'UIA_SelectionActiveEndAttributeId',
    'AnnotationType_DeletionChange', 'IUIAutomationEventHandler',
    'UIA_DragDropEffectPropertyId', 'TreeTraversalOptions_PostOrder',
    'UIA_DragIsGrabbedPropertyId', 'UIA_NamePropertyId',
    'UIA_StylesFillPatternColorPropertyId', 'UIA_IsHiddenAttributeId',
    'UIA_ObjectModelPatternId', 'SupportedTextSelection_Multiple',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'IUIAutomationProxyFactory', 'UIA_SpreadsheetItemPatternId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_StylesStyleIdPropertyId', 'TextEditChangeType_AutoComplete',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_CenterPointPropertyId',
    'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId', 'DockPosition_Fill',
    'UIA_CaretPositionAttributeId', 'UIA_AnnotationTypesAttributeId',
    'IUIAutomationSelectionItemPattern', 'IUIAutomationOrCondition',
    'UIA_GridRowCountPropertyId', 'UIA_StyleNameAttributeId',
    'UIA_InvokePatternId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_AnnotationPatternId', 'UIA_ScrollItemPatternId',
    'HeadingLevel5', 'IUIAutomationStylesPattern',
    ...
    'AnnotationType_CircularReferenceError', 'UIA_MainLandmarkTypeId',
    'ZoomUnit', 'UIA_ClassNamePropertyId',
    'IUIAutomationTextPattern2', 'TextEditChangeType_AutoCorrect',
    'StructureChangeType_ChildrenReordered',
    'UIA_IsDockPatternAvailablePropertyId',
    'IUIAutomationCustomNavigationPattern',
    'UIA_ControlTypePropertyId', 'IUIAutomationElement2',
    'TextEditChangeType_Composition',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'UIA_ForegroundColorAttributeId', 'UIA_AriaPropertiesPropertyId',
    'TreeScope_Children', 'StyleId_Heading2',
    'NavigateDirection_FirstChild', 'Polite', 'UIA_ValuePatternId',
    'UIA_TextChildPatternId', 'UIA_ItemTypePropertyId',
    'SupportedTextSelection_Single', 'ToggleState_Indeterminate',
    'AnnotationType_DataValidationError',
    'CoalesceEventsOptions_Disabled', 'OrientationType_Vertical',
    'UIA_ItemStatusPropertyId', 'WindowInteractionState_Closing',
    'NotificationKind_ItemRemoved',
    'WindowInteractionState_NotResponding',
    'WindowInteractionState_Running', 'UIA_FlowsToPropertyId',
    'UIA_SplitButtonControlTypeId', 'UIA_Invoke_InvokedEventId',
    'UIA_RangeValueMaximumPropertyId',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_SpreadsheetItemFormulaPropertyId', 'TextUnit_Document',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_Drag_DragStartEventId', 'IUIAutomationSelectionPattern',
    'AnnotationType_EditingLockedChange', 'UIA_GridItemPatternId',
    'SynchronizedInputType_LeftMouseDown', 'UIA_ListControlTypeId',
    'NotificationProcessing_MostRecent',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_LegacyIAccessibleValuePropertyId',
    'IUIAutomationObjectModelPattern', 'StyleId_NumberedList',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'IUIAutomationSelectionPattern2', 'UIA_DockPatternId',
    'UIA_FontWeightAttributeId', 'NotificationProcessing',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'UIA_AutomationFocusChangedEventId', 'UIA_DragPatternId',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'IUIAutomationCacheRequest', 'IUIAutomationDragPattern',
    'UIA_SayAsInterpretAsMetadataId', 'UIA_GridItemColumnPropertyId',
    'UIA_IsControlElementPropertyId', 'UIA_OrientationPropertyId',
    'IUIAutomationElementArray', 'UIA_LayoutInvalidatedEventId',
    'UIA_IsReadOnlyAttributeId',
    'UIA_IndentationFirstLineAttributeId',
    'ScrollAmount_SmallDecrement', 'IUIAutomationTextRangeArray',
    'IUIAutomationSpreadsheetPattern', 'AnnotationType_Sensitive',
    'UIA_StructureChangedEventId', 'OrientationType_Horizontal',
    'UIA_AnnotationTypesPropertyId', 'UIA_WindowIsModalPropertyId',
    'UIA_RangeValueSmallChangePropertyId',
    'TextPatternRangeEndpoint_Start', 'UIA_OutlineStylesAttributeId',
    'UIA_AutomationPropertyChangedEventId', 'UIA_StyleIdAttributeId',
    'TextEditChangeType_None', 'UIA_ScrollPatternId',
    'StyleId_Heading8', 'AnnotationType_Footer',
    'IUIAutomationWindowPattern', 'HeadingLevel_None',
    'ToggleState_On', 'UIA_BulletStyleAttributeId',
    'UIA_RangeValuePatternId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_DockDockPositionPropertyId', 'UIA_GridItemRowPropertyId',
    'TextUnit', 'UIA_Transform2ZoomLevelPropertyId',
    'ProviderOptions_ClientSideProvider',
    'ScrollAmount_SmallIncrement',
    'ProviderOptions_ServerSideProvider', 'UIA_ProcessIdPropertyId',
    'UIA_TextEditPatternId', 'UIA_BoundingRectanglePropertyId',
    'UIA_StylesShapePropertyId', 'IUIAutomationElement7',
    'TreeTraversalOptions_Default', 'UIA_CaretBidiModeAttributeId',
    'IUIAutomationTransformPattern', 'TextUnit_Character',
    'IUIAutomationNotCondition', 'IUIAutomationTogglePattern',
    'UIA_AfterParagraphSpacingAttributeId',
    'UIA_DragGrabbedItemsPropertyId', 'IUIAutomationElement4',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'ZoomUnit_LargeIncrement', 'IUIAutomationTextRange',
    'UIA_WindowControlTypeId', 'AnnotationType_Unknown',
    'ZoomUnit_SmallDecrement', 'UIA_StrikethroughStyleAttributeId',
    'UIA_SizeOfSetPropertyId', 'HeadingLevel1', 'Off',
    'NotificationKind', 'UIA_ThumbControlTypeId',
    'IUIAutomationPropertyChangedEventHandler',
    'AnnotationType_SpellingError',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_IsPeripheralPropertyId', 'StyleId_Heading5',
    'IUIAutomation2', 'UIA_OptimizeForVisualContentPropertyId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'ExpandCollapseState_Collapsed', 'UIA_CustomControlTypeId',
    'UIA_AnimationStyleAttributeId', 'IUIAutomation',
    'WindowVisualState_Minimized', 'HeadingLevel8',
    'UIA_InputReachedTargetEventId', 'SupportedTextSelection_None',
    'UIA_IsKeyboardFocusablePropertyId', 'AnnotationType_Footnote',
    'UIA_MenuModeEndEventId', 'AnnotationType_Author',
    'UIA_TabsAttributeId', 'IUIAutomationInvokePattern',
    'AnnotationType_InsertionChange',
    'UIA_SayAsInterpretAsAttributeId',
    'TextEditChangeType_CompositionFinalized',
    'UIA_ClickablePointPropertyId', 'UIA_DropTarget_DroppedEventId',
    'UIA_DragDropEffectsPropertyId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_IsScrollItemPatternAvailablePropertyId', 'UiaChangeInfo',
    'UIA_IsRequiredForFormPropertyId', 'IUIAutomationGridPattern',
    'UIA_AnnotationObjectsPropertyId',
    'ConnectionRecoveryBehaviorOptions', 'NavigateDirection_Parent',
    'IUIAutomation3', 'UIA_WindowCanMaximizePropertyId',
    'UIA_PositionInSetPropertyId', 'UIA_RangeValueValuePropertyId',
    'UIA_LegacyIAccessibleSelectionPropertyId', 'TextUnit_Line',
    'RowOrColumnMajor_RowMajor', 'DockPosition_Bottom',
    'UIA_CulturePropertyId', 'UIA_TableItemPatternId',
    'PropertyConditionFlags_None',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_MultipleViewPatternId', 'SupportedTextSelection',
    'UIA_IsDataValidForFormPropertyId',
    'IUIAutomationNotificationEventHandler', 'IUIAutomation5',
    'IUIAutomationTextChildPattern',
    'ProviderOptions_UseClientCoordinates',
    'UIA_ToggleToggleStatePropertyId',
    'UIA_TextEdit_TextChangedEventId', 'IUIAutomationElement3',
    'WindowVisualState_Maximized', 'UIA_MenuModeStartEventId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_GridPatternId', 'HeadingLevel6',
    'UIA_RangeValueLargeChangePropertyId',
    'TreeTraversalOptions_LastToFirstOrder', 'UIA_TextPatternId',
    'UIA_Transform2ZoomMaximumPropertyId',
    'ExpandCollapseState_Expanded', 'UIA_IsEnabledPropertyId',
    'UIA_GridItemRowSpanPropertyId', 'WindowVisualState_Normal',
    'UIA_TablePatternId', 'ProviderOptions',
    'UIA_IsActiveAttributeId', 'UIA_PaneControlTypeId',
    'UIA_AnnotationAuthorPropertyId', 'UIA_AutomationIdPropertyId',
    'UIA_FormLandmarkTypeId', 'WindowVisualState', 'HeadingLevel2',
    'NavigateDirection_PreviousSibling', 'StyleId_Emphasis',
    'UIA_RangeValueMinimumPropertyId', 'IUIAutomationElement6',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'UIA_DescribedByPropertyId',
    'StructureChangeType_ChildrenBulkRemoved',
    'UIA_SelectionCanSelectMultiplePropertyId', 'Assertive',
    'IUIAutomationDropTargetPattern',
    'UIA_SelectionItemIsSelectedPropertyId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'IUIAutomationProxyFactoryEntry', 'UIA_ValueValuePropertyId',
    ...
    'UIA_NotificationEventId', 'UIA_LegacyIAccessiblePatternId',
    'UIA_IsValuePatternAvailablePropertyId', 'UIA_SystemAlertEventId',
    'UIA_TextControlTypeId', 'UIA_ScrollBarControlTypeId',
    'TreeScope', 'CoalesceEventsOptions_Enabled',
    'UIA_StatusBarControlTypeId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_UnderlineColorAttributeId', 'HeadingLevel9',
    'UIA_MarginLeadingAttributeId',
    'ExpandCollapseState_PartiallyExpanded',
    'UIA_SelectionItemPatternId',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_WindowIsTopmostPropertyId', 'UIA_FontNameAttributeId',
    'UIA_TableColumnHeadersPropertyId', 'OrientationType',
    'UIA_Window_WindowClosedEventId',
    'ProviderOptions_HasNativeIAccessible',
    'IUIAutomationTextEditPattern',
    'UIA_LegacyIAccessibleChildIdPropertyId', 'IUIAutomationElement8',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_TransformPatternId', 'AutomationElementMode',
    'UIA_TransformPattern2Id', 'UIA_FullDescriptionPropertyId',
    'UIA_AcceleratorKeyPropertyId', 'UIA_UnderlineStyleAttributeId',
    'UIA_HasKeyboardFocusPropertyId', 'TextUnit_Page',
    'ZoomUnit_LargeDecrement', 'UIA_DropTargetPatternId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'StyleId_Heading3', 'RowOrColumnMajor_Indeterminate',
    'ToggleState', 'UIA_CustomNavigationPatternId',
    'UIA_SearchLandmarkTypeId', 'UIA_MarginTrailingAttributeId',
    'UIA_BackgroundColorAttributeId',
    'UIA_LocalizedLandmarkTypePropertyId', 'UIA_TogglePatternId',
    'IRawElementProviderSimple', 'StyleId_Heading4',
    'PropertyConditionFlags', 'StructureChangeType_ChildAdded',
    'UIA_EditControlTypeId', 'UIA_DataGridControlTypeId',
    ...
    'AnnotationType_FormatChange', 'UIA_FillColorPropertyId',
    'UIA_RadioButtonControlTypeId', 'UIA_InputDiscardedEventId',
    'UIA_ScrollHorizontalViewSizePropertyId', 'UIA_ChangesEventId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_MarginTopAttributeId', 'DockPosition_Left',
    'SynchronizedInputType_RightMouseUp', 'DockPosition_Right',
    'TextUnit_Format', 'UIA_Text_TextChangedEventId',
    'UIA_Selection2LastSelectedItemPropertyId', 'TreeScope_Ancestors',
    'UIA_Transform2CanZoomPropertyId',
    'AnnotationType_UnsyncedChange', 'UIA_StylesPatternId',
    'AnnotationType_Mathematics', 'NotificationKind_ActionAborted',
    'UIA_IsDialogPropertyId', 'NavigateDirection_LastChild',
    'IUIAutomation4', 'HeadingLevel7', 'UIA_LandmarkTypePropertyId',
    'UIA_TitleBarControlTypeId',
    'UIA_ActiveTextPositionChangedEventId',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_Selection2ItemCountPropertyId',
    'IUIAutomationTableItemPattern', 'UIA_CustomLandmarkTypeId',
    'StyleId_Heading7', 'UIA_ListItemControlTypeId',
    'UIA_OverlineColorAttributeId', 'AnnotationType_Endnote',
    'UIA_WindowCanMinimizePropertyId',
    'StructureChangeType_ChildrenInvalidated', 'UIA_TabControlTypeId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'AutomationElementMode_None', 'IUIAutomationEventHandlerGroup',
    'UIA_TableRowOrColumnMajorPropertyId', 'StyleId_Subtitle',
    'CUIAutomation', 'StyleId_Heading6',
    'UIA_AnnotationDateTimePropertyId',
    'TextPatternRangeEndpoint_End', 'UIA_OutlineThicknessPropertyId',
    'UIA_ImageControlTypeId', 'IUIAutomationTextRange2',
    'UIA_ControllerForPropertyId', 'UIA_TreeItemControlTypeId',
    'StyleId_Heading1', 'UIA_WindowWindowVisualStatePropertyId',
    'UIA_IsOffscreenPropertyId', 'ScrollAmount',
    'UIA_SemanticZoomControlTypeId',
    'UIA_TextFlowDirectionsAttributeId', 'UIA_IsItalicAttributeId',
    'OrientationType_None', 'AutomationElementMode_Full',
    'UIA_ProviderDescriptionPropertyId',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_StylesFillColorPropertyId', 'UIA_HyperlinkControlTypeId',
    'UIA_TableControlTypeId', 'NavigateDirection_NextSibling',
    'UIA_StylesExtendedPropertiesPropertyId', 'StyleId_Normal',
    'UIA_IsTextPattern2AvailablePropertyId', 'StyleId_Heading9',
    'UIA_SummaryChangeId', 'IUIAutomationSynchronizedInputPattern',
    'UIA_VirtualizedItemPatternId',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_VisualEffectsPropertyId', 'HeadingLevel3',
    'UIA_WindowPatternId', 'TreeScope_None', 'IUIAutomationCondition',
    'UIA_CapStyleAttributeId', 'UIA_NavigationLandmarkTypeId',
    'NotificationProcessing_ImportantAll',
    'UIA_CheckBoxControlTypeId', 'UIA_SpreadsheetPatternId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_IsItemContainerPatternAvailablePropertyId', 'TextUnit_Word',
    'NotificationKind_ItemAdded', 'DockPosition',
    'IUIAutomationGridItemPattern',
    'ProviderOptions_RefuseNonClientSupport',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_DataItemControlTypeId', 'PropertyConditionFlags_IgnoreCase',
    'UIA_AccessKeyPropertyId',
    'UIA_IsStylesPatternAvailablePropertyId',
    'UIA_Drag_DragCompleteEventId',
    'UIA_ScrollVerticalViewSizePropertyId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'NotificationKind_Other', 'PropertyConditionFlags_MatchSubstring',
    'UIA_SynchronizedInputPatternId', 'ExpandCollapseState_LeafNode',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_TreeControlTypeId', 'UIA_IsTablePatternAvailablePropertyId',
    'ZoomUnit_SmallIncrement', 'IUIAutomationExpandCollapsePattern',
    'IUIAutomationMultipleViewPattern',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_DocumentControlTypeId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'UIA_LiveRegionChangedEventId', 'TreeScope_Subtree',
    'UIA_Window_WindowOpenedEventId', 'StyleId_BulletedList',
    'UIA_DropTarget_DragLeaveEventId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_MenuBarControlTypeId', 'AnnotationType_ExternalChange',
    'UIA_IsSuperscriptAttributeId', 'RowOrColumnMajor_ColumnMajor',
    'IUIAutomationChangesEventHandler', 'UIA_ButtonControlTypeId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_TabItemControlTypeId', 'ToggleState_Off',
    'UIA_LineSpacingAttributeId', 'NotificationKind_ActionCompleted',
    'AnnotationType_MoveChange', 'UIA_GridColumnCountPropertyId',
    'ScrollAmount_LargeDecrement', 'IUIAutomationTextRange3',
    'SynchronizedInputType_KeyUp', 'UIA_CultureAttributeId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_Selection_InvalidatedEventId',
    'UIA_GridItemColumnSpanPropertyId',
    'UIA_OverlineStyleAttributeId',
    'IUIAutomationItemContainerPattern', 'IAccessible',
    'AnnotationType_TrackChanges', 'AnnotationType_ConflictingChange',
    'IUIAutomationElement', 'IUIAutomationRangeValuePattern',
    'UIA_CalendarControlTypeId',
    'IUIAutomationLegacyIAccessiblePattern', 'UIA_GroupControlTypeId',
    'UIA_LevelPropertyId', 'UIA_SliderControlTypeId',
    'UIA_ValueIsReadOnlyPropertyId',
    'UIA_LocalizedControlTypePropertyId', 'UIA_FontSizeAttributeId',
    'TextEditChangeType', 'UIA_BeforeParagraphSpacingAttributeId',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_ToolTipClosedEventId',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'UIA_SelectionPatternId', 'UIA_LinkAttributeId',
    'UIA_MenuControlTypeId', 'AnnotationType_AdvancedProofingIssue',
    'TextPatternRangeEndpoint', 'UIA_AsyncContentLoadedEventId',
    'UIA_AppBarControlTypeId', 'UIA_LabeledByPropertyId',
    'UIA_IndentationLeadingAttributeId', 'UIA_HeadingLevelPropertyId',
    'AnnotationType_FormulaError', 'UIA_ToolTipControlTypeId',
    'ProviderOptions_UseComThreading', 'IUIAutomationDockPattern',
    'ProviderOptions_NonClientAreaProvider',
    'UIA_ToolBarControlTypeId', 'UIA_LegacyIAccessibleRolePropertyId',
    'AnnotationType_Header', 'StyleId_Title',
    'UIA_HelpTextPropertyId', 'UIA_SelectionSelectionPropertyId',
    'StructureChangeType',
    'NotificationProcessing_ImportantMostRecent',
    'IUIAutomationAnnotationPattern', 'IUIAutomationElement9',
    'UIA_MenuOpenedEventId', 'UIA_StrikethroughColorAttributeId',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_HeaderControlTypeId', 'UIA_FlowsFromPropertyId',
    'StructureChangeType_ChildRemoved', 'UIA_MarginBottomAttributeId',
    'HeadingLevel4', 'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_FrameworkIdPropertyId', 'SynchronizedInputType',
    ...
    'UIA_FillTypePropertyId', 'StyleId_Custom',
    'UIA_OutlineColorPropertyId', 'UIA_HeaderItemControlTypeId',
    'TextUnit_Paragraph', 'IUIAutomationTransformPattern2',
    'UIA_IndentationTrailingAttributeId', 'IUIAutomationAndCondition',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_MenuClosedEventId', 'UIA_RotationPropertyId',
    'UIA_SpinnerControlTypeId', 'UIA_TransformCanRotatePropertyId',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_DropTarget_DragEnterEventId', 'UIA_IsSubscriptAttributeId',
    'UIA_TextPattern2Id',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_ExpandCollapsePatternId', 'UIA_SelectionPattern2Id',
    'UIA_TableRowHeadersPropertyId', 'IUIAutomationPropertyCondition',
    'IUIAutomationScrollPattern', 'UIA_SeparatorControlTypeId',
    'ExtendedProperty', 'SynchronizedInputType_KeyDown',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_ProgressBarControlTypeId', 'IUIAutomationBoolCondition',
    'ZoomUnit_NoAmount', 'UIA_ScrollVerticallyScrollablePropertyId',
    'DockPosition_Top', 'UIA_MenuItemControlTypeId',
    'UIA_AnnotationObjectsAttributeId', 'CoalesceEventsOptions',
    'AnnotationType_GrammarError', 'StyleId_Quote',
    'ProviderOptions_ProviderOwnsSetFocus', 'UIA_AriaRolePropertyId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_RuntimeIdPropertyId', 'NotificationProcessing_All',
    'NavigateDirection', 'UIA_SizePropertyId', 'DockPosition_None',
    'UIA_IsTextPatternAvailablePropertyId', 'CUIAutomation8',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_ItemContainerPatternId', 'WindowInteractionState',
    'ProviderOptions_OverrideProvider', 'IUIAutomation6',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_IsDragPatternAvailablePropertyId',
    'UIA_NativeWindowHandlePropertyId', 'IUIAutomationTreeWalker',
    'ScrollAmount_LargeIncrement', 'AnnotationType_Highlighted',
    'UIA_LiveSettingPropertyId', 'UIA_StylesStyleNamePropertyId'
]

_check_version('1.1.14', 1673435311.402880)
